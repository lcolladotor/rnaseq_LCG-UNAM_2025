...
* Wednesday January 29:
  - 9-11 am: introduction to Bioconductor, expression data R/Bioconductor objects and visualization: `r BiocStyle::Biocpkg("SummarizedExperiment")` and `r BiocStyle::Biocpkg("iSEE")`
...
* Participation
  ...
  - (optional, strongly encouraged for your own career) Community building: CDSB Slack (introduce yourself), Bluesky, GitHub, etc.
* Public work
